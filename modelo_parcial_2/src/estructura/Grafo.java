...
public abstract class Grafo {
	...
	public void crearArista(String origen, String destino, int peso, float tiempo) {
		// ver tema de vertices que puedan estar no creados y se deseen incluir
		// en la arista
		AristaViaje a = new AristaViaje(origen, destino, peso, tiempo);
		listaArista.add(a);
		cargarAdyacencias(a);
	}
	
	private void cargarAdyacencias(Arista nueva){
	...
	public void DFS_recorrido(String inicio){
	...
	public void BFS_recorrido(String inicio){
		Vertice ini=devolverVertice(inicio);
